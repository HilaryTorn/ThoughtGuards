...
const SystemMetrics: React.FC<SystemMetricsProps> = ({ counts, totalAnalyzed, totalDetections }) => {
  ...
  const chartData = Object.keys(CATEGORY_STYLES).map((key) => ({
    ...
    color: COLOR_MAP[CATEGORY_STYLES[key as DetectionCategory].color] || '#94a3b8'
  }));
